...
# This script will create a Symphony object from the Smillie2019 cells.
...
cell_type = args[1]
batch_theta = args[2]
outprefix = paste0('/data/srlab1/jkang/hla2023/symphony/Smillie_', cell_type, '_batch', batch_theta) # file names label
...
exp_combined = readRDS(paste0('/data/srlab1/jkang/hla2023/eqtl_pseudobulk/0_data/exp_pers_Smillie_', cell_type, '.rds'))

# Read in cell metadata
meta_Smillie = readRDS(paste0('/data/srlab1/jkang/hla2023/eqtl_pseudobulk/0_data/cell_meta_Smillie_', cell_type, '.rds'))
sample_meta = read.csv('/data/srlab1/jkang/hla2023/data/meta/sample_meta_Smillie_completeHLA.csv')
meta_combined = left_join(meta_Smillie, sample_meta[,-1])
