...
# Given a cell type, raw counts, a single variant, and gene, this script will test whether the regulatory variant is an eQTL using the NBME model for the Randolph et al. dataset.
...
outprefix = '/data/srlab1/jkang/hla2023/eqtl_single_cell/1_sceQTL_nostate/Randolph_NBME_'
