...
# This script will create a Symphony object from the OneK1K cells.
...
cell_type = args[1]
batch_theta = args[2]
outprefix = paste0('/data/srlab1/jkang/hla2023/symphony/OneK1K_', cell_type, '_batch', batch_theta) # file names label
...
exp_combined = readRDS(paste0('/data/srlab1/jkang/hla2023/eqtl_pseudobulk/0_data/exp_pers_OneK1K_', cell_type, '.rds'))

# Read in cell metadata
meta_OneK1K = readRDS(paste0('/data/srlab1/jkang/hla2023/eqtl_pseudobulk/0_data/cell_meta_OneK1K_', cell_type, '.rds'))
sample_meta = read.csv('/data/srlab1/jkang/hla2023/data/meta/sample_meta_OneK1K_completeHLA.csv')
meta_combined = left_join(meta_OneK1K, sample_meta[,-1])
...
ref_harmObj = harmony::HarmonyMatrix(
        ...
        vars_use = c('Batch'),             ## variable to integrate out
