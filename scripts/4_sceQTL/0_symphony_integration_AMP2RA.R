...
# This script will create a Symphony object from the AMP2RA cells.
...
cell_type = args[1]
batch_theta = args[2]
outprefix = paste0('/data/srlab1/jkang/hla2023/symphony/AMP2RA_', cell_type, '_batch', batch_theta) # file names label
...
exp_combined = readRDS(paste0('/data/srlab1/jkang/hla2023/eqtl_pseudobulk/0_data/exp_pers_AMP2RA_', cell_type, '.rds'))

# Read in cell metadata
meta_AMP2RA = readRDS(paste0('/data/srlab1/jkang/hla2023/eqtl_pseudobulk/0_data/cell_meta_AMP2RA_', cell_type, '.rds'))
sample_meta = read.csv('/data/srlab1/jkang/hla2023/data/meta/sample_meta_AMP2RA_completeHLA.csv')
meta_combined = left_join(meta_AMP2RA, sample_meta[,-1])
